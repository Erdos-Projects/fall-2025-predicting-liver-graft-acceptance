...
expr_values.to_csv(r"C:/Users/nanth/Desktop/Erdo_work/GSE145780_expression_uncollapsed.csv")
gene_annotations.to_csv(r"C:/Users/nanth/Desktop/Erdo_work/GSE145780_gene_annotations.csv")
...
expr_collapsed.to_csv(r"C:/Users/nanth/Desktop/Erdo_work/GSE145780_expression_collapsed.csv")
...
dists = pd.DataFrame(
    squareform(pdist(expr_collapsed.T, metric='cityblock')),
    index=expr_collapsed.columns,
    columns=expr_collapsed.columns
)
...
linkage_matrix = linkage(pdist(expr_collapsed.T, metric='cityblock'), method='average')
dendro = dendrogram(linkage_matrix, labels=expr_collapsed.columns, no_plot=True)
...
chang_manfiltered.to_csv(r"C:/Users/nanth/Desktop/Erdo_work/GSE145780_expression_collapsed_filtered.csv")
